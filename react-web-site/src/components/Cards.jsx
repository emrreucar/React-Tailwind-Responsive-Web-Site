    ...
    <div className="w-full py-[10rem] px-4 bg-white ">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 ">
        ...
        <div className="w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          ...
          <p className="text-center text-4xl font-semibold">$249</p>
          <div className="text-center font-medium">
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <p className="text-center text-4xl font-semibold">$449</p>
          <div className="text-center font-medium">
            <p className="py-2 border-b mx-8 mt-8">5000 GB Storage</p>
            <p className="py-2 border-b mx-8">9 Granted User</p>
            <p className="py-2 border-b mx-8">Send up to 12GB</p>
          </div>
          <button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 ">Start Trial</button>
        </div>
      </div>
